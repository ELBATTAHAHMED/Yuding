package com.ahmed.reservationservice.filter;
...
/**
 * Security audit and request-tracing filter for Reservation Service.
...
public class SecurityAuditFilter extends OncePerRequestFilter {
    ...
    private static final Set<String> SENSITIVE_QUERY_PARAMS = Set.of(
            "password", "pass", "pwd", "token", "secret", "cvv", "card", "pan", "authorization", "numcarte"
    );
