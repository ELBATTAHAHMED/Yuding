...
/**
 * Service-level Spring Security configuration for User Service (Identity domain).
...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        // Enforce BCrypt cost 12 standard as defined in Phase 7 specification
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/apiu/**").permitAll()
