package com.ahmed.aiservice.filter;
...
/**
 * Security audit and request-tracing filter for AI Service.
 ...
 * (passwords, tokens, PAN, CVV, API keys) are never logged.
 */
@Component
...
public class SecurityAuditFilter extends OncePerRequestFilter {
    ...
    private static final Set<String> SENSITIVE_QUERY_PARAMS = Set.of(
            "password", "pass", "pwd", "token", "secret", "cvv", "card", "pan", "authorization", "apikey", "api-key"
    );
