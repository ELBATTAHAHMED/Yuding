...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const closeOnEscape = (event: KeyboardEvent) => { if (event.key === 'Escape') { setPhotoMenuOpen(false); photoTriggerRef.current?.focus(); } };
